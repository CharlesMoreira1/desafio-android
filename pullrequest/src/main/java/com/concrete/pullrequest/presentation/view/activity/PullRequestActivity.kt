package com.concrete.pullrequest.presentation.view.activity
...
import com.concrete.pullrequest.R
...
import com.concrete.pullrequest.presentation.view.adapter.PullRequestAdapter
...
class PullRequestActivity : BaseActivity() {
    ...
    lateinit var itemBottom: ItemReload
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setToolbar(title = com.desafioandroid.R.string.title_toolbar_pull_request, showHomeAsUp = true)
    ...
    private fun iniUi() {
        itemBottom = findViewById(com.desafioandroid.R.id.item_bottom)
    ...
    private fun populateStatePullRequest(pullRequestList: List<PullRequestResponse>) {
        ...
        val stateOpenString = getString(com.desafioandroid.R.string.message_state_open_pull_request, stateOpen)
        val stateClosedString = getString(com.desafioandroid.R.string.message_state_closed_pull_request, stateClosed)

        text_total_state.text = getString(com.desafioandroid.R.string.division_concat, stateOpenString, stateClosedString)
            .addColorSpecificText(this, com.desafioandroid.R.color.colorOrange, stateOpenString)
    }
    ...
    private fun showError() {
        ...
        itemBottom.buttonRetry.setOnClickListener { view ->
    ...
    private fun showLoadingAndHideButtonRefresh(isVisibility: Boolean) {
        if (isVisibility) itemBottom.showLoading() else itemBottom.showErrorRetry()
    }
}
